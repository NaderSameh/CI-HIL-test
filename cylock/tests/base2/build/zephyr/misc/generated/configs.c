...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZTEST_STACKSIZE, 2048);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRYPTO_TINYCRYPT_SHIM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRYPTO_TINYCRYPT_SHIM_MAX_SESSION, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRYPTO_TINYCRYPT_SHIM_DRV_NAME, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MGMT_CBORATTR_MAX_SIZE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZTEST_ASSERT_VERBOSE, 0);
