 ...
 *(".kernel.*")
 ...
 ztest_suite_node_area : ALIGN_WITH_INPUT SUBALIGN(4) { _ztest_suite_node_list_start = .; KEEP(*(SORT_BY_NAME(._ztest_suite_node.static.*))); _ztest_suite_node_list_end = .; } > SRAM AT > FLASH
    __data_region_end = .;
